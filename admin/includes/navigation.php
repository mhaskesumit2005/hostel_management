                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="dashboard.php">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="../assets/images/logo-icon-nav4.png" style="height:200px;"  alt="homepage" class="mt-3 dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="../assets/images/logo-icon-nav4.png" style="height:200px;"  alt="homepage" class="mt-3 light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
